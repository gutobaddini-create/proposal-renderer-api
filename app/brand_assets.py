...
def get_logo_path() -> Path:
    ...
    if not FALLBACK_LOGO_PATH.exists():
        ...
        draw.ellipse((44, 44, 176, 176), fill=NAVY, outline=GOLD, width=5)
        ...
        draw.text((205, 72), "Lobo Baddini", fill=NAVY, font=name_font)
        draw.text((207, 112), "Advocacia", fill=NAVY, font=name_font)
        draw.line((206, 153, 545, 153), fill=GOLD, width=3)
        draw.text((207, 164), "Propostas juridicas empresariais", fill=NAVY, font=subtitle_font)
